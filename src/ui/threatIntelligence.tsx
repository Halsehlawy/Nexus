        ...
        <div className="flex flex-col flex-1" style={{ marginLeft: 'var(--sidebar-width)' }}>
          <header className="top-bar">
            <div className="top-bar-left">
              <div className="home-section">Threat Intelligence </div>
            </div>
          ...
          <section className="stat-grid">
            <button className="data" onClick={() => alert('Events clicked')}>
              <StatCard icon={gridIcon} count={690} label="Events" />
            </button>
            <button className="data" onClick={() => alert('Active Agents clicked')}>
              <StatCard icon={usersIcon} count={120} label="Active Agents" />
            </button>
            <button className="data" onClick={() => alert('Alerts clicked')}>
              <StatCard icon={alertIcon} count={95} label="Alerts" />
            </button>
            <button className="data" onClick={() => alert('Incidents clicked')}>

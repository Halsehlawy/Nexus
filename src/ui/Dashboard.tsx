  ...
  return (
    <>
      ...
      <div className="flex flex-col flex-1" style={{ marginLeft: 'var(--sidebar-width)' }}>
        ...
        <img src="/graph1.png" alt="Graph 1" style={{ width: '45%' }} />
        <img src="/graph2.png" alt="Graph 2" style={{ width: '45%' }} />
        </div>
        <div className='image-container'>
        <img src="/graph33.png" alt="Graph 3" style={{ borderRadius: '8px', width: '90%', margin: '0 auto' }} />
        </div>
      </div>
      </div>
    </>
